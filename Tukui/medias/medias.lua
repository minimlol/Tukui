...
C["media"] = {
	...
	["font"] = [=[Interface\Addons\Tukui\medias\fonts\calibri.ttf]=], -- general font of tukui
	["uffont"] = [[Interface\AddOns\Tukui\medias\fonts\calibri.ttf]], -- general font of unitframes
	["dmgfont"] = [[Interface\AddOns\Tukui\medias\fonts\calibri_bold.ttf]], -- general font of dmg / sct
