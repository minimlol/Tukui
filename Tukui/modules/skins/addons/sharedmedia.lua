...
LSM:Register("statusbar","Tukui Bar", [[Interface\AddOns\Tukui\medias\textures\normTex.tga]])
LSM:Register("border", "Tukui Border", [[Interface\AddOns\Tukui\medias\textures\glowTex.tga]])
