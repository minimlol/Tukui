...
TukuiBarLower:SetPoint("BOTTOM", InvTukuiActionBarBackground, "BOTTOM", 0, 0)
...
TukuiBarUpper:SetPoint("BOTTOM", TukuiBarLower, "BOTTOM", 0, 0)
...
TukuiBar1:SetPoint("BOTTOMLEFT", TukuiBarLower, "BOTTOMLEFT", 0, 0)
TukuiBar1:SetFrameStrata("BACKGROUND")
TukuiBar1:SetFrameLevel(1)
G.ActionBars.Bar1 = TukuiBar1

local TukuiBar2 = CreateFrame("Frame", "TukuiBar2", TukuiBarLower, "SecureHandlerStateTemplate")
TukuiBar2:SetTemplate()
TukuiBar2:SetPoint("BOTTOMRIGHT", TukuiBarLower, "BOTTOMRIGHT", 0, 0)
...
local TukuiBar3 = CreateFrame("Frame", "TukuiBar3", TukuiBarUpper, "SecureHandlerStateTemplate")
TukuiBar3:SetTemplate()
TukuiBar3:SetPoint("TOPLEFT", TukuiBarUpper, "TOPLEFT", 0, 0)
...
local TukuiBar4 = CreateFrame("Frame", "TukuiBar4", TukuiBarUpper, "SecureHandlerStateTemplate")
TukuiBar4:SetTemplate()
TukuiBar4:SetPoint("TOPRIGHT", TukuiBarUpper, "TOPRIGHT", 0, 0)
...
--[[ i have no fucking idea what these two are for
